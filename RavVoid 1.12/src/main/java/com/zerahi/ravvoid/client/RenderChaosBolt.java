package com.zerahi.ravvoid.client;
...
public class RenderChaosBolt<T extends EntityChaosBolt> extends Render<T>
{
    private final float scale;

    public RenderChaosBolt(RenderManager renderManagerIn, float scaleIn)
    {
