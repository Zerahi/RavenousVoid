...
public class ContainedEntropyStep extends Block
{
    public static final PropertyDirection FACING = BlockHorizontal.FACING;
    public static final PropertyEnum<ContainedEntropyStep.EnumHalf> HALF = PropertyEnum.<ContainedEntropyStep.EnumHalf>create("half", ContainedEntropyStep.EnumHalf.class);
    public static final PropertyEnum<ContainedEntropyStep.EnumShape> SHAPE = PropertyEnum.<ContainedEntropyStep.EnumShape>create("shape", ContainedEntropyStep.EnumShape.class);
    /**
     * B: .. T: xx
     * B: .. T: xx
     */
    ...
    public ContainedEntropyStep(String name, Material materialIn)
    {
        super(materialIn);
        this.setDefaultState(this.blockState.getBaseState().withProperty(FACING, EnumFacing.NORTH).withProperty(HALF, ContainedEntropyStep.EnumHalf.BOTTOM).withProperty(SHAPE, ContainedEntropyStep.EnumShape.STRAIGHT));
        this.modelBlock = this;
        this.modelState = this.getDefaultState();
    ...
    private static List<AxisAlignedBB> getCollisionBoxList(IBlockState bstate)
    {
        ...
        boolean flag = bstate.getValue(HALF) == ContainedEntropyStep.EnumHalf.TOP;
        list.add(flag ? AABB_SLAB_TOP : AABB_SLAB_BOTTOM);
        ContainedEntropyStep.EnumShape blockstairs$enumshape = (ContainedEntropyStep.EnumShape)bstate.getValue(SHAPE);

        if (blockstairs$enumshape == ContainedEntropyStep.EnumShape.STRAIGHT || blockstairs$enumshape == ContainedEntropyStep.EnumShape.INNER_LEFT || blockstairs$enumshape == ContainedEntropyStep.EnumShape.INNER_RIGHT)
        {
            list.add(getCollQuarterBlock(bstate));
        }

        if (blockstairs$enumshape != ContainedEntropyStep.EnumShape.STRAIGHT)
        {
    ...
    private static AxisAlignedBB getCollEighthBlock(IBlockState bstate)
    {
        ...
        switch ((ContainedEntropyStep.EnumShape)bstate.getValue(SHAPE))
        {
            case OUTER_LEFT:
            default:
    ...
    public BlockFaceShape getBlockFaceShape(IBlockAccess worldIn, IBlockState state, BlockPos pos, EnumFacing face)
    {
        ...
        {
            return face == EnumFacing.UP == (state.getValue(HALF) == ContainedEntropyStep.EnumHalf.TOP) ? BlockFaceShape.SOLID : BlockFaceShape.UNDEFINED;
        }
        else
        {
            ContainedEntropyStep.EnumShape blockstairs$enumshape = (ContainedEntropyStep.EnumShape)state.getValue(SHAPE);

            if (blockstairs$enumshape != ContainedEntropyStep.EnumShape.OUTER_LEFT && blockstairs$enumshape != ContainedEntropyStep.EnumShape.OUTER_RIGHT)
            {
    ...
    {
        return state.getValue(HALF) == ContainedEntropyStep.EnumHalf.TOP;
    }
    ...
    public IBlockState getStateForPlacement(World worldIn, BlockPos pos, EnumFacing facing, float hitX, float hitY, float hitZ, int meta, EntityLivingBase placer)
    {
        ...
        iblockstate = iblockstate.withProperty(FACING, placer.getHorizontalFacing()).withProperty(SHAPE, ContainedEntropyStep.EnumShape.STRAIGHT);
        return facing != EnumFacing.DOWN && (facing == EnumFacing.UP || (double)hitY <= 0.5D) ? iblockstate.withProperty(HALF, ContainedEntropyStep.EnumHalf.BOTTOM) : iblockstate.withProperty(HALF, ContainedEntropyStep.EnumHalf.TOP);
    }
    ...
    {
        IBlockState iblockstate = this.getDefaultState().withProperty(HALF, (meta & 4) > 0 ? ContainedEntropyStep.EnumHalf.TOP : ContainedEntropyStep.EnumHalf.BOTTOM);
    ...
    public int getMetaFromState(IBlockState state)
    {
        ...
        if (state.getValue(HALF) == ContainedEntropyStep.EnumHalf.TOP)
        {
            i |= 4;
        }
    ...
    private static ContainedEntropyStep.EnumShape getStairsShape(IBlockState p_185706_0_, IBlockAccess p_185706_1_, BlockPos p_185706_2_)
    {
        ...
        if (isBlockStairs(iblockstate) && p_185706_0_.getValue(HALF) == iblockstate.getValue(HALF))
        {
            ...
            if (enumfacing1.getAxis() != ((EnumFacing)p_185706_0_.getValue(FACING)).getAxis() && isDifferentStairs(p_185706_0_, p_185706_1_, p_185706_2_, enumfacing1.getOpposite()))
            {
                ...
                {
                    return ContainedEntropyStep.EnumShape.OUTER_LEFT;
                }

                return ContainedEntropyStep.EnumShape.OUTER_RIGHT;
            }
        }
        ...
        if (isBlockStairs(iblockstate1) && p_185706_0_.getValue(HALF) == iblockstate1.getValue(HALF))
        {
            ...
            if (enumfacing2.getAxis() != ((EnumFacing)p_185706_0_.getValue(FACING)).getAxis() && isDifferentStairs(p_185706_0_, p_185706_1_, p_185706_2_, enumfacing2))
            {
                ...
                {
                    return ContainedEntropyStep.EnumShape.INNER_LEFT;
                }

                return ContainedEntropyStep.EnumShape.INNER_RIGHT;
            }
        }

        return ContainedEntropyStep.EnumShape.STRAIGHT;
    }
    ...
    {
        return state.getBlock() instanceof ContainedEntropyStep;
    }
        ...
        switch (mirrorIn)
        {
            case LEFT_RIGHT:
                ...
                if (enumfacing.getAxis() == EnumFacing.Axis.Z)
                {
                    ...
                    {
                        case OUTER_LEFT:
                            return state.withRotation(Rotation.CLOCKWISE_180).withProperty(SHAPE, ContainedEntropyStep.EnumShape.OUTER_RIGHT);
                        case OUTER_RIGHT:
                            return state.withRotation(Rotation.CLOCKWISE_180).withProperty(SHAPE, ContainedEntropyStep.EnumShape.OUTER_LEFT);
                        case INNER_RIGHT:
                            return state.withRotation(Rotation.CLOCKWISE_180).withProperty(SHAPE, ContainedEntropyStep.EnumShape.INNER_LEFT);
                        case INNER_LEFT:
                            return state.withRotation(Rotation.CLOCKWISE_180).withProperty(SHAPE, ContainedEntropyStep.EnumShape.INNER_RIGHT);
                        default:
