...
public class CustomTriggers implements ICriterionTrigger
{
    private final ResourceLocation ID;
    private final Map listeners = Maps.newHashMap();

    public CustomTriggers(String parString)
    {
  super();
  ID = new ResourceLocation(parString);
    }
    
    public CustomTriggers(ResourceLocation parRL)
    {
     super();
     ID = parRL;
    }
 ...
 public void addListener(PlayerAdvancements playerAdvancementsIn, ICriterionTrigger.Listener listener)
    {
        CustomTriggers.Listeners tameanimaltrigger$listeners = (Listeners) this.listeners.get(playerAdvancementsIn);

        if (tameanimaltrigger$listeners == null)
        {
            tameanimaltrigger$listeners = new CustomTriggers.Listeners(playerAdvancementsIn);
 ...
 public void removeAllListeners(PlayerAdvancements playerAdvancementsIn)
     ...
     */
    @Override
 public CustomTriggers.Instance deserializeInstance(JsonObject json, JsonDeserializationContext context)
    {
        return new CustomTriggers.Instance(this.getId());
    }
    ...
    {
        CustomTriggers.Listeners voidtrigger$listeners = (Listeners) this.listeners.get(parPlayer.getAdvancements());

        if (voidtrigger$listeners != null)
        {
            voidtrigger$listeners.trigger(parPlayer);
        }
    }
    ...
    static class Listeners
    {
        ...
        private final List<ICriterionTrigger.Listener> listeners = new ArrayList<ICriterionTrigger.Listener>();
